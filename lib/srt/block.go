...
func (customB *Block) IsValid() bool {
	return customB.SeqNo > 0 &&
		customB.TimeStart != "" && customB.TimeEnd != "" && customB.TimeSep != "" &&
		customB.MainTrack != ""
}

func (customB *Block) decodeSeqNo(lineStr string) (isSeqNo bool, err error) {
...
func (customB *Block) decodeTimeLine(lineStr string) (isTimeLine bool, err error) {
...
func (customB *Block) decodeMainTrack(lineStr string) (isMain bool, err error) {
...
func (customB *Block) decodeSubTrack(lineStr string) (isSub bool, err error) {
...
func (customB *Block) encode(flagInverse bool, flagTrackExportedMode int) []byte {
