...
func (customC *Cfg) Sync() error {
	...
	viper.Set("niutrans.app_key", customC.AppKey)
	viper.Set("niutrans.max_single_text_length", customC.MaxSingleTextLength)
	viper.Set("niutrans.qps", customC.QPS)
	viper.Set("niutrans.max_coroutine_num", customC.MaxCoroutineNum)
