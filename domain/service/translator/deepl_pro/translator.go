...
func (customT *Translator) GetShortId() string                      { return "dlp" }
...
func (customT *Translator) Translate(ctx context.Context, args *translator.TranslateArgs) (*translator.TranslateRes, error) {
	...
	respBytes, err := translator.RequestSimpleHttp(ctx, customT, TRANSLATE_API_PRO, true, reqBytes, map[string]string{
